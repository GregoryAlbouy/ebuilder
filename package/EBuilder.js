...
var EBuilderAnimation_1 = require("./EBuilderAnimation");
...
var EBuilder = function EBuilder(source) {
  ...
  return {
    ...
    given: function given() {
      ...
      var register = function register(ref) {
        ...
        } else new EBuilderError_1["default"]('Invalid given() argument input', ref);
      };
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                _context.next = 6;
                return new EBuilderAnimation_1["default"](ms).swap2(element, swapped);
    ...
    dispatch: function dispatch(nameInput, emitterInput) {
      var emitter = !emitterInput ? this.element : 'isEBuilder' in emitterInput ? emitterInput.element : emitterInput;
