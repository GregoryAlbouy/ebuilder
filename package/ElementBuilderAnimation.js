...
var ElementBuilderAnimation = /*#__PURE__*/function () {
  function ElementBuilderAnimation(duration) {
    var _this = this;

    (0, _classCallCheck2["default"])(this, ElementBuilderAnimation);
    this.duration = 200;
    this.then = {
    ...
    if (duration && duration < 0) throw new ElementBuilderError_1["default"]('Invalid animation duration', name);else this.duration = duration || this.duration;
  }
  /*
  ...
  (0, _createClass2["default"])(ElementBuilderAnimation, [{
    key: "swap",
  ...
  return ElementBuilderAnimation;
}();
